...
if __name__ == '__main__':
    ...
    results_preprocess, _ = modulos.preprocess_point_clouds(source_cloud, target_cloud, VOXEL_SIZE, VERBOSE)
    source_down, target_down, source_features, target_features = results_preprocess

    if VERBOSE:
        print("Aplicando o alinhamento RANSAC e FGR...")
    result_gr, _ = modulos.global_registration(source_down, target_down, source_features, target_features,
                                               VOXEL_SIZE, VERBOSE)
    result_fgr, _ = modulos.fast_global_registration(source_down, target_down, source_features,
